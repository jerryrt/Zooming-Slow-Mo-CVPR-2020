...
from codes.modules.zsm.easy_fusion import EasyFusion
...
def adapt_easy_fusion(weights, name_prefix):
    ...
    fusion.pyramid_fusion.module_ba.load_state_dict(adapt_pyramid_fusion(weights, f"{name_prefix}.pcd_align", forward=False))
